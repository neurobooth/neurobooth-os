...
fname = (
    "Z:/data/100064_2022-09-28/100064_2022-09-28_14h-54m-26s_timing_test_obs_IPhone.mov"
)
...
audio_ts = np.linspace(
    my_clip.audio.start, my_clip.audio.end, int(my_clip.audio.end * my_clip.audio.fps)
)

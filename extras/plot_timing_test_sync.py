...
if __name__ == "__main__":
    parser = OptionParser()
    parser.add_option("-i", "--session-id", dest="session_id", type="string", default="100064_2022-09-28", help="Specify which timing test path to use")
    parser.add_option("-t", "--session-time", dest="session_time", type="string", default="_14h-54m-26s", help="Specify which timing test path to use")
    ...
    print("timing_test_files", timing_test_files)

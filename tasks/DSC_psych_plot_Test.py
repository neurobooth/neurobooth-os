...
stim = [
        TextBox2(win, pos=(0, 9), color='black', units='deg', letterHeight=2.2, lineSpacing=.7, size=(20,None),
                 text=f"press <b>press</b> when you see this symbol, press <b>press</b> when you see this symbol", 
                 font="Cairo", borderColor=None, fillColor=None, editable=False, alignment='right', anchor="center"),
        ]

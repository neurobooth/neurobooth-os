...
win = visual.Window((1800, 1800), monitor='testMonitor',
                    allowGUI=True, color='white')
...
stim = [
    ...
    visual.ImageStim(win, image=f"DSC/images/1.gif",
                     pos=(0, 6), units='deg'),  # , size=7),
    visual.ImageStim(win, image='DSC/images/key.png',
                     pos=(0, 0), units='deg'),  # , size=15),
...
for ss in stim:
    ss.draw()
win.flip()
response_events = keyboard.waitForReleases(
    maxWait=3000.0, keys=['1', '2', '3'])

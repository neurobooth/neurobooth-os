...
stim = [
    visual.ImageStim(
        win, image=op.join(rootdir, f"images/1.gif"), pos=(0, 10), units="deg"
    ),
    visual.ImageStim(
        win, image=op.join(rootdir, "images/key.png"), pos=(0, 0), units="deg"
    ),
    visual.Rect(
        win,
        units="deg",
    ...
    my_textbox2(
        win, "You should press 1 on the keyboard when you see this symbol", (0, -9)
    ),
    visual.ImageStim(
        win, image=op.join(rootdir, "continue.png"), pos=(0, 0), units="deg"
    ),
]

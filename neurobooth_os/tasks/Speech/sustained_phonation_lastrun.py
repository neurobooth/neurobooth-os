...
expName = 'sustained_phonation'  # from the Builder filename that created this script
...
sound_1 = sound.Sound('sust_phon_instructions.wav', secs=-1, stereo=True, hamming=True,
    name='sound_1')
...
sound_3 = sound.Sound('sust_phon_practice_comp_test_instr.wav', secs=-1, stereo=True, hamming=True,
    name='sound_3')

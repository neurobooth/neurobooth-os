...
sound_1 = sound.Sound('Sustained_Phonation_1.wav', secs=-1, stereo=True, hamming=True,
    name='sound_1')
...
while continueRoutine:
    ...
    # *text* updates
    if text.status == NOT_STARTED and tThisFlip >= asarray(sound_1.getDuration()+0.5)-frameTolerance:
        # keep track of start time/frame for later

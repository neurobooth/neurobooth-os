...
class sustained_phonation():
    ...
    def run(self):
        ...
        sustainph_instructions = visual.TextStim(win=self.win, name='sustainph_instructions',
        ...
        sustainph_practice = visual.TextStim(win=self.win, name='sustainph_practice',
        ...
        sustainph_postpractice_instr = visual.TextStim(win=self.win, name='sustainph_postpractice_instr',
        ...
        sustainph_begintask = visual.TextStim(win=self.win, name='sustainph_begintask',
        ...
        sustainph_endtask = visual.TextStim(win=self.win, name='sustainph_endtask',
        ...
        core.wait(5)
        mic.record(180, f"{self.path}{self.subj_id}_sustained_phonation_practice.wav")
        mic.setMarker()
        event.waitKeys()
        mic.stop()
        self.win.color = (0, 0, 0)
        ...
        core.wait(5)
        mic.record(180, f"{self.path}{self.subj_id}_sustained_phonation_task.wav")
        mic.setMarker()
        event.waitKeys()
        mic.stop()
        self.win.color = (0, 0, 0)

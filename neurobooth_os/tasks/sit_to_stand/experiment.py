...
class Sit_to_Stand():
    def __init__(
        ...
        self.pname_inst_vid = op.join(
            self.fpath, op.basename(path_instruction_video))
    ...
    def run(self):
        ...
        instruction_video = visual.MovieStim3(
            win=self.win, filename=self.pname_inst_vid, noAudio=False)
        ...
        end_audio = sound.Sound(self.fpath + '/end.wav',

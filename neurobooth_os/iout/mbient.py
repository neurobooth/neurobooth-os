...
class Sensor:
    ...
    def data_handler(self, ctx, data):
        ...
        # pylsl.local_clock()
        vals = [local_clock(), values[0].x, values[0].y, values[0].z,
    ...
    def close(self):
        self.device.on_disconnect = lambda status: print(
            f"Mbient {self.dev_name} disconnected!")
        # Stops data logging
        # print("stop logging")
